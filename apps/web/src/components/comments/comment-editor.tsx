  ...
  return (
    <div
      className={cn(
        ...
        'focus-within:ring-2 focus-within:ring-offset-2 focus-within:outline-hidden',
    ...
    >
      <Textarea
        ...
        className='min-h-[44px] resize-none border-none px-3 py-2 text-sm focus-visible:ring-0 focus-visible:ring-offset-0 sm:min-h-10 sm:text-base'
        autoComplete='off'
        autoCorrect='off'
        autoCapitalize='off'
        spellCheck='false'
        {...rest}
      />
      <div className='flex flex-row items-center gap-1 px-2 py-1 sm:px-1.5'>
        <Button
          aria-label={t('blog.comments.toggle-bold')}
          variant='ghost'
          size='icon'
          className='size-8 min-h-[32px] min-w-[32px] sm:size-7'

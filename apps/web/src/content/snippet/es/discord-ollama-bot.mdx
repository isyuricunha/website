...
date: 2025-12-04
author: Yuri Cunha
description: Un bot asíncrono completo de Discord que se integra con una instancia local de Ollama y realiza un seguimiento del historial de usuarios en SQLite.
tags:
  - python
  - discord
  - ollama
...
<Callout type='warning'>
  Nunca subas tu token real de Discord a un repositorio público. Usa variables de entorno (por ejemplo, `python-dotenv`) para implementaciones en producción.
</Callout>

...
<Callout type='warning'>
  Estas son **mis configuraciones personales**. Revisa y ajusta las configuraciones antes de aplicarlas a tu entorno. Algunas configuraciones, como rutas de archivos, claves de API y preferencias, pueden necesitar personalización para tu entorno.
</Callout>
...
<Callout type='warning'>
  El archivo `settings.json` contiene una clave de API (`gitCommitSuggestions.openAIKey`). Asegúrate de eliminar o reemplazar esta clave con la tuya, o mejor aún, usa variables de entorno para datos sensibles.
</Callout>

<Callout type='info'>
  Antes de aplicar estas configuraciones a una instalación nueva, revisa cada ajuste para asegurarte de que coincida con tu flujo de trabajo y preferencias. Algunas configuraciones, como rutas de archivos, pueden necesitar ajustes para tu entorno.
</Callout>

...
date: 2025-12-04
author: Yuri Cunha
description: Ein vollständiger, asynchroner Discord-Bot, der mit einer lokalen Ollama-Instanz integriert ist und den Nutzerverlauf in SQLite speichert.
tags:
  - python
  - discord
  - ollama
...
<Callout type='warning'>
  Gib dein tatsächliches Discord-Token niemals in ein öffentliches Repository ein. Verwende für Produktivumgebungen Umgebungsvariablen (z. B. `python-dotenv`).
</Callout>

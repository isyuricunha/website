...
<ExpandableSection title='ゲーミングPC - ハードウェア' icon='Zap'>x
<ItemGrid
  items={[
    {
    ...
    },
    {
      ...
      name: 'Intel® Core™ Ultra 9 プロセッサー 285K',
      description: 'CPU',
    ...
    },
    {
      ...
      name: 'Gamdias Chione M4-420 ウォータークーラー',
      description: 'CPUクーラー',
...
<ExpandableSection title='インフラ' icon='Shield'><ItemGrid
  items={[
    {

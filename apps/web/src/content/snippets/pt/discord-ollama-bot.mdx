...
date: 2025-12-04
author: Yuri Cunha
description: Um bot completo e assíncrono do Discord que integra com uma instância local do Ollama e registra histórico de usuários no SQLite.
tags:
  - python
  - discord
  - ollama
...
<Callout type='warning'>
  Nunca faça commit do seu token real do Discord em um repositório público. Em produção, use variáveis de ambiente (por exemplo, `python-dotenv`).
</Callout>

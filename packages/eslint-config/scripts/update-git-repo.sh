...
This is a ESLint config inspector generated by [@isyuricunha/eslint-config](https://github.com/isyuricunha/honghong.me/tree/main/packages/eslint-config)
EOF
...
git push git@github.com:isyuricunha/eslint-config-inspector.git main -f

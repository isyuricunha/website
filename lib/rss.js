...
const generateRssItem = (post) => `
  <item>
    <guid>https://www.website.yuricunha.xyz/blog/${post.fields.slug}</guid>
    <title>${post.fields.title}</title>
    <link>https://www.website.yuricunha.xyz/blog/${post.fields.slug}</link>
...
const generateRss = (posts) => {
  ...
  <rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
    <channel>
      ...
      <link>https://www.website.yuricunha.xyz/blog</link>
      <description>Designer, developer and maker of things.</description>
      <language>en</language>
      <lastBuildDate>${new Date(
        sortedPosts[0].fields.publishDate
      ).toUTCString()}</lastBuildDate>
      <atom:link href="https://www.website.yuricunha.xyz/rss.xml" rel="self" type="application/rss+xml"/>

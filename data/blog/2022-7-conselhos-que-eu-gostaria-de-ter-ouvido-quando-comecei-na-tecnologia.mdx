...
<Image
  ...
  src={'/static/images/blog/conselhos-que-eu-gostaria-de-ter-ouvido-quando-comecei-na-tecnologia/banner.png'}
  width={1905 / 2}
  height={957 / 2}
  layout='responsive'
  blurDataURL={
...
Porque, um pequeno erro de sintaxe pode gerar muitos problemas, como esquecer um ponto e vírgula ou escrever *<code>`fuction()`</code>* em vez de *<code>`function()`</code>* — e, às vezes isso dói no coração.
<br /><br />

...
image: '/static/images/blog/i-would-like-to-die-but-i-dont-want-to-die/i-would-like-to-die-but-i-dont-want-to-die.gif'
published: true
---
...
<Image
  ...
  src={'/static/images/blog/i-would-like-to-die-but-i-dont-want-to-die/i-would-like-to-die-but-i-dont-want-to-die.gif'}
  width={1905 / 2}
  height={957 / 2}
  layout="responsive"
  blurDataURL={

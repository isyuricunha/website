...
publishedAt: '2024-09-26T04:50:00-03:00'
summary: "i believe everyone here must know what depression is, right?"
tags: ['mentalhealth', 'depressionjourney', 'selfcompassion']
by: { name: 'Yuri Cunha', avatar: '/static/images/toMe/avatar-cyan.png' }
image: '/static/images/blog/i-would-like-to-die-but-i-dont-want-to-die/i-would-like-to-die-but-i-dont-want-to-die.png'
published: true
---
...
<Image
  ...
  src={'/static/images/blog/i-would-like-to-die-but-i-dont-want-to-die/i-would-like-to-die-but-i-dont-want-to-die.png'}
  width={1905 / 2}
  height={957 / 2}
  layout="responsive"
  blurDataURL={

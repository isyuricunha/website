---
title: 'My experience making a movie rating website.'
...
The card component looks like this, [link to repo](https://github.com/isyuricunha/movie-web-typescript/blob/main/components/Card/Card.tsx):
...
And that's it! I now have a functioning movie review site. There are a few more features that you can go and check out on [ScuffedMDB](https://smdb.website.yuricunha.xyz), and if you want to host it for your friend group there is a [guide](https://github.com/isyuricunha/scuffedmdb).

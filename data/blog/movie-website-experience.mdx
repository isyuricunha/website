...
And that's it! I now have a functioning movie review site. There are a few more features that you can go and check out on [ScuffedMDB](https://smdb.isyuricunha.xyz), and if you want to host it for your friend group there is a [guide](https://github.com/isyuricunha/scuffedmdb).

...
publishedAt: '2024-09-24T17:21:00-03:00'
summary: "a personal journey of social withdrawal, introspection, and the quest for inner peace amidst modern superficiality"
tags: ['solitude', 'introspection', 'modernlife']
by: { name: 'Yuri Cunha', avatar: '/static/images/toMe/avatar-cyan.png' }
image: '/static/images/blog/reflections-on-solitude-and-superficiality/reflections-on-solitude-and-superficiality.png'
published: true
---
...
<Image
  ...
  src={'/static/images/blog/reflections-on-solitude-and-superficiality/reflections-on-solitude-and-superficiality.png'}
  width={1905 / 2}
  height={957 / 2}
  layout="responsive"
  blurDataURL={

...
publishedAt: '2025-01-02T21:46:00-03:00'
summary: "tbh, i dont know']
by: { name: 'Yuri Cunha', avatar: '/static/images/toMe/avatar-cyan.png' }
image: '/static/images/blog/what-if-everything-goes-wrong/what-if-everything-goes-wrong.png'
published: true
---
...
<Image
  ...
  src={'/static/images/blog/what-if-everything-goes-wrong/what-if-everything-goes-wrong.png'}
  width={1905 / 2}
  height={957 / 2}
  layout="responsive"
  blurDataURL={

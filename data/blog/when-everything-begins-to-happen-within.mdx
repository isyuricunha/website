...
publishedAt: '2025-02-10T20:35:00-03:00'
summary: "we rewrite our story from within"
by: { name: 'Yuri Cunha', avatar: '/static/images/toMe/me-face.png' }
image: '/static/images/blog/when-everything-begins-to-happen-within/when-everything-begins-to-happen-within.gif'
published: true
---
...
<Image
  ...
  src={'/static/images/blog/when-everything-begins-to-happen-within/when-everything-begins-to-happen-within.gif'}
  width={1905 / 2}
  height={957 / 2}
  layout="responsive"
  blurDataURL={
